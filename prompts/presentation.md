...
The calling agent ends its report with these five choices and waits for the user's selection. The coordinator does not offer choices or wait for a reply:
